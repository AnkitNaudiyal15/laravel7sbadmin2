    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form class="player" method="POST" action="{{route('players.update',$player->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user"
                                        ...
                                        value={{$player->player_jersey_number}}>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="first_name"
                                        id="exampleInputEmail" placeholder="Enter first name..." required maxlength="75"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="last_name"
                                        ...
                                        maxlength="75" value={{$player->last_name}}>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="url" class="form-control form-control-user" name="image_uri"
                                        ...
                                        maxlength="200" value={{urldecode($player->image_uri)}}>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" name="hundreds"
                                        ...
                                        maxlength="75" value={{$player->hundreds}}>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="country"
                                        id="exampleInputPassword" placeholder="Enter Country..." required maxlength="75"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" name="matches"
                                        ...
                                        maxlength="75" value={{$player->matches}}>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" name="fifties"
                                        ...
                                        maxlength="75" value={{$player->fifties}}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <select name="team_id" class="custom-select mr-sm-2" id="process-type" >
